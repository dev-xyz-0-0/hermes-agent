...
class TestResolveProvider:
    ...
    def test_alias_evolink_ai(self):
...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_resolve_evolink_custom_base_url(self, monkeypatch):
        ...
        monkeypatch.setenv("EVOLINK_BASE_URL", "https://proxy.evolink.example/v1")
        creds = resolve_api_key_provider_credentials("evolink")
        assert creds["base_url"] == "https://proxy.evolink.example/v1"
...
class TestHasAnyProviderConfigured:
    ...
    def test_claude_code_creds_ignored_on_fresh_install(self, monkeypatch, tmp_path):
        ...
        for var in ("OPENROUTER_API_KEY", "OPENAI_API_KEY", "ANTHROPIC_API_KEY",
                     "ANTHROPIC_TOKEN", "OPENAI_BASE_URL", "EVOLINK_API_KEY",
                     "EVOLINK_BASE_URL"):
