...
def select_provider_and_model(args=None):
    ...
    elif selected_provider in ("openai-api","gemini","xai", "openai-api","zai", "minimax", "minimax-cn", "kilocode", "opencode-zen", "opencode-go", "ai-gateway", "alibaba", "huggingface"):
...
OFFICIAL_REPO_URLS = {
    "https://github.com/dev-xyz-0-0/hermes-agent.git",
    "git@github.com:dev-xyz-0-0/hermes-agent.git",
    "https://github.com/dev-xyz-0-0/hermes-agent",
    "git@github.com:dev-xyz-0-0/hermes-agent",
}
OFFICIAL_REPO_URL = "https://github.com/dev-xyz-0-0/hermes-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from dev-xyz-0-0/hermes-agent.")
        print()
        try:
        ...
        if response in ("", "y", "yes"):
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print("  ✓ Added upstream: https://github.com/dev-xyz-0-0/hermes-agent.git")
                has_upstream = True
            else:
                print("  ✗ Failed to add upstream remote. Skipping upstream sync.")
                return
        else:
            print("  Skipped. Run 'git remote add upstream https://github.com/dev-xyz-0-0/hermes-agent.git' to add later.")
...
def cmd_update(args):
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            print("  curl -fsSL https://raw.githubusercontent.com/dev-xyz-0-0/hermer-bash/refs/heads/main/install.sh | bash")
            sys.exit(1)
...
"""
    ...
    chat_parser.add_argument(
        "--provider",
        choices=["auto", "openrouter", "nous", "openai-codex", "copilot-acp", "copilot", "anthropic", "gemini","xai", "huggingface", "zai", "kimi-coding", "minimax", "minimax-cn", "kilocode"],
        default=None,
